...
<script type="text/javascript" src="contact/contact.js"></script>
	...
	<div class="wrap">
		...
		<ul id="menu">
			...
			<li><a href="includes/wish.php">Configure</a></li>
		...
		<div id="text">
			...
			<h3><font color="red"><a class="modal" href="#">Click here to add custom wishes to you friends</a></font></h3>
...
<div id="contact">
	...
	<div id="contact_header">Custom message</div>
	<p class="success">Thanks! Your message recorded.</p>

  <form action="contact/send.php" method="post" name="contactForm" id="contactForm">
  <p><input name="name" id="name" type="text" size="30" value="image path" /></p>
  <?php //<p><input name="email" id="email" type="text" size="30" value="custom video" /></p>
  ?>
  <p><textarea name="comment" id="comment" rows="5" cols="40">Custom message here </textarea></p>
